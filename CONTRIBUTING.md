...
https://metacpan.org/release/App-Sqitch-Command-pgreset

You can use [`cpanminus`](https://metacpan.org/pod/App::cpanminus) to do this
without downloading the tarball first:

    $> cpanm --reinstall --installdeps --with-recommends App::Sqitch::Command::pgreset
...
You can also do this via cpanm directly:
    ...
    $> cpanm --reinstall --installdeps --with-develop --with-recommends App::Sqitch::Command::pgreset
...
The code for this distribution is [hosted on GitHub](https://github.com/houseabsolute/App-Sqitch-Command-pgreset).
...
can submit an issue report [via the web](https://github.com/houseabsolute/App-Sqitch-Command-pgreset/issues).
