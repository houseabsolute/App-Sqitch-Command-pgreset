...
requires "App::Sqitch::Command" => "0";
requires "App::Sqitch::Role::ConnectingCommand" => "0";
requires "App::Sqitch::Role::ContextCommand" => "0";
requires "App::Sqitch::Types" => "0";
requires "App::Sqitch::X" => "0";
requires "DateTime" => "0";
